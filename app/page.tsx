      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-32 md:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/10 via-teal-500/10 to-purple-500/10 p-12 text-center backdrop-blur-sm border border-white/10 md:p-20 shadow-2xl shadow-blue-500/5">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-6 text-sm text-slate-500">✓ No credit card required ✓ Free forever for early adopters ✓ Cancel anytime</p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="grid gap-12 md:grid-cols-4 lg:grid-cols-5">
            <div className="col-span-2">
              <div className="flex items-center gap-2.5 group cursor-pointer mb-4">
                <div className="relative h-10 w-10 overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 via-teal-500 to-purple-500 p-[2px] shadow-lg shadow-blue-500/30 transition-all duration-500 group-hover:shadow-blue-500/50 group-hover:scale-105">
                  <div className="flex h-full w-full items-center justify-center rounded-2xl bg-[#050505]">
                    <Zap size={20} className="fill-blue-400 text-blue-400" />
                  </div>
                </div>
                <div>
                  <span className="text-xl font-bold tracking-tight">
              ...
              <p className="text-sm text-slate-500 max-w-sm leading-relaxed">
                ProHire is the leading AI career platform for the Pakistani job market, helping professionals land their dream jobs through intelligent matching and skill development.
              </p>
              <div className="mt-6 flex gap-4">
                <Link href="#" className="text-slate-500 transition-all hover:text-white hover:scale-110">
                  <Twitter size={18} />
                </Link>
                <Link href="#" className="text-slate-500 transition-all hover:text-white hover:scale-110">
                  <Linkedin size={18} />
          ...
          <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 md:flex-row">
            ...
            <div className="flex gap-6 text-xs text-slate-500">
              ...
              <Link href="#" className="hover:text-slate-300 transition-colors">GDPR</Link>
            </div>
          </div>
        </div>
      </footer>
...
const Bell = (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>;
const GraduationCap = (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>;
