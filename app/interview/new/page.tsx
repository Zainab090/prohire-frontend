    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-lg px-6 py-10">
        ...
        <p className="mt-1 text-sm text-textMuted">
          The Interview Agent will generate role-specific questions based on
          this job and your profile.
        </p>

        <div className="card mt-6 p-5">
          <label className="mb-2 block text-xs font-medium text-textMuted">
            Interview Mode
          </label>
          ...
          <label className="mb-2 mt-5 block text-xs font-medium text-textMuted">
            Language
          </label>
          ...
          {language !== "en" && (
            <p className="mt-2 text-xs text-textMuted">
              Answer in {language === "ur" ? "Urdu" : "Roman Urdu"} — you&apos;ll
              also get suggested professional English phrasing for each answer.
            </p>
          )}
